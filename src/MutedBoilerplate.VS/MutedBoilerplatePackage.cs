...
[InstalledProductRegistration("Muted Boilerplate", "Visually mute boilerplate code.", "0.1.0")]
[ProvideMenuResource("Menus.ctmenu", 1)]
[ProvideOptionPage(typeof(MuteOptionsPage), "Muted Boilerplate", "General", 0, 0, true)]
...
public sealed class MutedBoilerplatePackage : AsyncPackage
{
    protected override async Task InitializeAsync(CancellationToken ct, IProgress<ServiceProgressData> progress)
    {
        ...
        MutedBoilerplateCommands.Register(commandService, state);
    }
}
