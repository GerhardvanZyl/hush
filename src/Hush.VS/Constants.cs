...
internal static class Constants
{
    ...
    public const string ClassificationPrefix = "hush.";
    public const string ClassTelemetry = "hush.telemetry";
    public const string ClassLogging = "hush.logging";
    public const string ClassSignature = "hush.signature";
    public const string ClassGuards = "hush.guards";
    public static string UserSlotClass(int slot) => $"hush.user{slot}";
}
