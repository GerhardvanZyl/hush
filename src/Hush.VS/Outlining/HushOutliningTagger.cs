...
internal sealed class HushOutliningTagger : ITagger<IOutliningRegionTag>
{
    private readonly ITextBuffer _buffer;
    private readonly MuteStateService _state;
    private readonly SnapshotMuteCache _cache;

    public HushOutliningTagger(ITextBuffer buffer, MuteStateService state)
    {
        _buffer = buffer;
        _state = state;
    ...
    private void OnStateChanged(object? sender, MuteStateChangedEventArgs e)
    {
        ...
        //
        // Enable-side fix: see HushClassifier.OnStateChanged. The pre-toggle
