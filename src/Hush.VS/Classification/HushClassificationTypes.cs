...
/// </summary>
internal static class HushClassificationTypes
{
...
#pragma warning disable IDE0044, CS8618
    ...
    [Export(typeof(ClassificationTypeDefinition))]
    [Name("hush.user1")] internal static ClassificationTypeDefinition User1;
    [Export(typeof(ClassificationTypeDefinition))]
    [Name("hush.user2")] internal static ClassificationTypeDefinition User2;
    [Export(typeof(ClassificationTypeDefinition))]
    [Name("hush.user3")] internal static ClassificationTypeDefinition User3;
    [Export(typeof(ClassificationTypeDefinition))]
    [Name("hush.user4")] internal static ClassificationTypeDefinition User4;
    [Export(typeof(ClassificationTypeDefinition))]
    [Name("hush.user5")] internal static ClassificationTypeDefinition User5;
    [Export(typeof(ClassificationTypeDefinition))]
    [Name("hush.user6")] internal static ClassificationTypeDefinition User6;
    [Export(typeof(ClassificationTypeDefinition))]
    [Name("hush.user7")] internal static ClassificationTypeDefinition User7;
    [Export(typeof(ClassificationTypeDefinition))]
    [Name("hush.user8")] internal static ClassificationTypeDefinition User8;
